...
import org.projectfloodlight.core.SwitchDriverSubHandshakeAlreadyStarted;
import org.projectfloodlight.core.SwitchDriverSubHandshakeCompleted;
import org.projectfloodlight.core.SwitchDriverSubHandshakeNotStarted;
...
public class OFSwitchBaseTest {
    ...
    public void testPacketInStopThrottle() throws InterruptedException {
        // XXX this test seems to depend on other tests running first
        // Should write so it can run on its own.
        floodlightProvider.addSwitchEvent(anyLong(),
                (String)anyObject(), anyBoolean());
        ...
        // Sleep for 10 msec, next packet should disable throttling
        Thread.sleep(10);
        assertFalse(sw.inputThrottled(pi));
        assertFalse(sw.inputThrottleEnabled());
   }
