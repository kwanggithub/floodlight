...
import org.projectfloodlight.counter.NullCounterStore;
import org.projectfloodlight.learningswitch.LearningSwitch;
...
public class LearningSwitchTest extends FloodlightTestCase {
    ...
    public void setUp() throws Exception {
        ...
        fmc.addService(LearningSwitch.class, learningSwitch);
        fmc.addService(IFloodlightProviderService.class, mockFloodlightProvider);
        fmc.addService(ICounterStoreService.class, new NullCounterStore());
