...
public class MockDeviceManager extends DeviceManagerImpl {
     ...
     * @param the timestamp to use as the timestamp for learning
    ...
    public IDevice learnEntity(long macAddress, Short vlan,
        ...
        if (ipv4Address != null && ipv4Address == 0)
            ipv4Address = null;
        Date d = updatedDate;
        if (updatedDate == null) d = new Date();
    ...
    public IDevice learnEntity(long macAddress, Short vlan,
                               ...
                               Integer switchPort,
                               boolean processUpdates) {
        return learnEntity(macAddress, vlan, ipv4Address, switchDPID, 
                           switchPort, null, processUpdates);
    }
