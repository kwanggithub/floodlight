...
import org.projectfloodlight.device.internal.DeviceSyncRepresentation;
import org.projectfloodlight.device.internal.Entity;
import org.projectfloodlight.device.internal.DeviceManagerImpl.ClassState;
import org.projectfloodlight.device.internal.DeviceSyncRepresentation.SyncEntity;
import org.projectfloodlight.device.test.MockEntityClassifier;
import org.projectfloodlight.device.test.MockEntityClassifierMac;
import org.projectfloodlight.device.test.MockFlexEntityClassifier;
import org.projectfloodlight.flowcache.FlowReconcileManager;
...
public class DeviceManagerImplTest extends FloodlightTestCase {
    ...
    private void doTestEntityOrdering(boolean computeInsertionPoint) throws Exception {
        ...
        IEntityClass ec = (new DefaultEntityClassifier()).classifyEntity(e);
    ...
    private List<DeviceSyncRepresentation> getEntriesFromStore()
        ...
        try (IClosableIterator<Entry<String,
                                     Versioned<DeviceSyncRepresentation>>> iter =
                storeClient.entries()) {
            while(iter.hasNext()) {
