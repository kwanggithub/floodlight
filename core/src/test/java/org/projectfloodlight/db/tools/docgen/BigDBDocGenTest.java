...
import org.projectfloodlight.db.tools.cli.BigDBGen;
import org.projectfloodlight.db.tools.docgen.SampleQuery;
...
public class BigDBDocGenTest {
    ...
    public void testSaveQueries()
        ...
        al.add(new SampleQuery("/core/switch",
                               ...
                               "GET",
                               "",
                               "/org/projectfloodlight/core/bigdb/BigDBRestTestSwitchId.expected"));
        al.add(new SampleQuery("/core/switch",
                               "/core/switch[dpid=\"00:00:00:00:00:00:00:05\"]/port",
                               "GET",
                               "",
                                "/org/projectfloodlight/core/bigdb/BigDBRestTestSwitchIdPorts.expected"));
