...
import org.projectfloodlight.debugcounter.DebugCounter.CounterIndexStore;
import org.projectfloodlight.debugcounter.DebugCounter.RetCtrInfo;
...
public class CounterHierarchyGetTest extends FloodlightTestCase {
    ...
    public void setUp() throws Exception {
        ...
        mctr.get("linkd").put("linkevent", new CounterIndexStore(24, null));
    ...
    public void testHierarchicalCounterGet2() {
        ...
        x.put("00:00:00:00:00:00:00:03",
              new CounterIndexStore(30, new ConcurrentHashMap<String,CounterIndexStore>()));
        x.get("00:00:00:00:00:00:00:03").nextLevel.put("pktin",
                                                       new CounterIndexStore(333, null));
    ...
    public void testHierarchicalCounterGet3() {
        ...
        x.put("00:00:00:00:00:00:00:05",
              new CounterIndexStore(50, new ConcurrentHashMap<String,CounterIndexStore>()));
        x.get("00:00:00:00:00:00:00:05")
            .nextLevel.put("pktin",
                           new CounterIndexStore(555, new ConcurrentHashMap<String,CounterIndexStore>()));
        x.get("00:00:00:00:00:00:00:05").nextLevel.get("pktin").nextLevel.
            put("drops", new CounterIndexStore(1056, null));
