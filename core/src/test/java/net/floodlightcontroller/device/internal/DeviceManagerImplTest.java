...
import net.floodlightcontroller.device.internal.DeviceManagerImpl.ClassState;
...
import net.floodlightcontroller.device.test.MockEntityClassifierMac;
import net.floodlightcontroller.device.test.MockFlexEntityClassifier;
