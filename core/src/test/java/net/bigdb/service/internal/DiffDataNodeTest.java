...
import net.bigdb.data.DiffContainerDataNode;
import net.bigdb.data.DiffKeyedListDataNode;
...
import net.bigdb.schema.SchemaNodeNotFoundException;
...
public class DiffDataNodeTest extends MapperTest {
    ...
    public void initializeService() throws BigDBException {
        ...
        service.initializeFromResource("/net/bigdb/service/internal/DiffDataNodeTest.yaml");
