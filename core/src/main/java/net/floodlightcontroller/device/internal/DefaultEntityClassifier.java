        ...
        IFloodlightModule 
{
    ...
    protected static final DefaultEntityClass entityClass =
    ...
    @Override
    public IEntityClass getEntityClassByName(String entityClassName) {
        return entityClassName.equals(entityClass.getName()) ?
                    entityClass : null;
    }
}
