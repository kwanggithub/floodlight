...
import net.floodlightcontroller.core.bigdb.serializers.IPv4DataNodeSerializer;
import net.floodlightcontroller.core.bigdb.serializers.MACDataNodeSerializer;
...
public class Entity implements Comparable<Entity> {
    ...
    @BigDBSerialize(using=MACDataNodeSerializer.class)    
    public long getMacAddress() {
        return macAddress;
    }

    @BigDBProperty(value = "ip-address")
    @BigDBSerialize(using=IPv4DataNodeSerializer.class)    
    ...
    @BigDBProperty(value="active-since")
    @BigDBSerialize(using=ISODateDataNodeSerializer.class)
    @SuppressFBWarnings(value="EI_EXPOSE_REP")
    ...
    public String toString() {        
        ...
        if (switchDPID != null) {
            ...
            builder.append(HexString.toHexString(switchDPID));
        }
