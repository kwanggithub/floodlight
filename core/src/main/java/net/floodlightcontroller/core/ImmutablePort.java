...
import net.floodlightcontroller.core.bigdb.serializers.ByteArrayMACDataNodeSerializer;
import net.floodlightcontroller.core.bigdb.serializers.UIntegerDataNodeSerializer;
import net.floodlightcontroller.core.bigdb.serializers.UShortDataNodeSerializer;
...
public class ImmutablePort {
    ...
    @BigDBProperty("number")
    @BigDBSerialize(using=UShortDataNodeSerializer.class)
    public short getPortNumber() {
        return portNumber;
    }

    @BigDBSerialize(using=ByteArrayMACDataNodeSerializer.class)
    @BigDBProperty("hardware-address")
    ...
    @BigDBProperty("config-flags")
    @BigDBSerialize(using=UIntegerDataNodeSerializer.class)
    public int getConfigBitmap() {
        return EnumBitmaps.toBitmap(config);
    }
    ...
    @BigDBProperty("state-flags")
    @BigDBSerialize(using=UIntegerDataNodeSerializer.class)
    public int getState() {
        return this.stpState.getValue() 
                | (portStateLinkDown 
                        ? OFPortConfig.OFPPC_PORT_DOWN.getValue() : 0);
    }
    ...
    @BigDBProperty("current-features")
    @BigDBSerialize(using=UIntegerDataNodeSerializer.class)
    public int getCurrentFeaturesBitmap() {
        return EnumBitmaps.toBitmap(currentFeatures);
    }
    ...
    @BigDBProperty("advertised-features")
    @BigDBSerialize(using=UIntegerDataNodeSerializer.class)
    public int getAdvertisedFeaturesBitmap() {
        return EnumBitmaps.toBitmap(advertisedFeatures);
    }
    ...
    @BigDBProperty("supported-features")
    @BigDBSerialize(using=UIntegerDataNodeSerializer.class)
    public int getSupportedFeaturesBitmap() {
        return EnumBitmaps.toBitmap(supportedFeatures);
    }
    ...
    @BigDBProperty("peer-features")
    @BigDBSerialize(using=UIntegerDataNodeSerializer.class)
    public int getPeerFeaturesBitmap() {
        return EnumBitmaps.toBitmap(peerFeatures);
    }
