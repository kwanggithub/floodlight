...
import net.bigdb.data.serializers.BeanDataNodeSerializer;
import net.bigdb.data.serializers.BigDecimalDataNodeSerializer;
import net.bigdb.data.serializers.BigIntegerDataNodeSerializer;
import net.bigdb.data.serializers.BooleanArrayDataNodeSerializer;
import net.bigdb.data.serializers.BooleanDataNodeSerializer;
import net.bigdb.data.serializers.ByteArrayDataNodeSerializer;
import net.bigdb.data.serializers.ByteDataNodeSerializer;
import net.bigdb.data.serializers.CharArrayDataNodeSerializer;
import net.bigdb.data.serializers.CharacterDataNodeSerializer;
import net.bigdb.data.serializers.DoubleArrayDataNodeSerializer;
import net.bigdb.data.serializers.DoubleDataNodeSerializer;
import net.bigdb.data.serializers.EnumDataNodeSerializer;
import net.bigdb.data.serializers.FloatArrayDataNodeSerializer;
import net.bigdb.data.serializers.FloatDataNodeSerializer;
import net.bigdb.data.serializers.IntArrayDataNodeSerializer;
import net.bigdb.data.serializers.IntegerDataNodeSerializer;
import net.bigdb.data.serializers.IterableDataNodeSerializer;
import net.bigdb.data.serializers.IteratorDataNodeSerializer;
import net.bigdb.data.serializers.LongArrayDataNodeSerializer;
import net.bigdb.data.serializers.LongDataNodeSerializer;
import net.bigdb.data.serializers.MapDataNodeSerializer;
import net.bigdb.data.serializers.ObjectArrayDataNodeSerializer;
import net.bigdb.data.serializers.SelfDataNodeSerializer;
import net.bigdb.data.serializers.ShortArrayDataNodeSerializer;
import net.bigdb.data.serializers.ShortDataNodeSerializer;
import net.bigdb.data.serializers.StringDataNodeSerializer;
import net.bigdb.util.AnnotationUtils;
