...
public class PersistMemDataSource extends MemoryDataSource implements PersistMemDataSourceMBean {
    ...
    public synchronized void startup() throws BigDBException {
        try {
            ObjectName objectName = new ObjectName("net.bigdb:type=PersistMemDataSource,name="+file.getPath());
    ...
    /* (non-Javadoc)
     * @see net.bigdb.data.persistmem.PersistMemDataSourceMBean#getBytesWritten()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.bigdb.data.persistmem.PersistMemDataSourceMBean#getRealWrites()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.bigdb.data.persistmem.PersistMemDataSourceMBean#getRequestedWrites()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.bigdb.data.persistmem.PersistMemDataSourceMBean#getFile()
     */
    @Override
    public File getFile() {
    ...
    /* (non-Javadoc)
     * @see net.bigdb.data.persistmem.PersistMemDataSourceMBean#getNumExceptions()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.bigdb.data.persistmem.PersistMemDataSourceMBean#getMsInWrite()
     */
    @Override
