 ...
 *
 * <code>
 *  java -Dnet.bigdb.useAuth=true \
 *    -Dnet.bigdb.auth.defaultAuthorizer=net.bigdb.auth.RestrictedAuthorizer
 *    -Dnet.bigdb.auth.restrictedPolicyRecord=true
 *    -Dnet.bigdb.auth.restrictedPolicyFile=restricted.acl
 *    -Dnet.bigdb.auth.restrictedPolicyDefaultResult=STRONG_ACCEPT
