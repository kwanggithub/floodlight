...
public class OFFlowStatisticsReply implements OFStatistics, OFActionFactoryAware {
    public static final int MINIMUM_LENGTH = 88;
    ...
    /**
     * Gets the duration of the flow.
     * @return the duration of this flow.
     */
    @BigDBProperty("duration")
    public TimeDuration getDuratation() {
        return new TimeDuration(durationSeconds, durationNanoseconds);
    }
     ...
     * @return the priority
     */
    @BigDBProperty("priority")
    @BigDBSerialize(using=UnsignedShortSerializer.class)
