...
public class OFTableStatistics implements OFStatistics {
    public static final int MAX_TABLE_NAME_LEN = 32;
     ...
     */
    @BigDBSerialize(using=OFTableWildcardSerializer.class)
    @BigDBProperty("match-fields")
