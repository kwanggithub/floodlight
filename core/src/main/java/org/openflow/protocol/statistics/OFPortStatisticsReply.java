...
public class OFPortStatisticsReply implements OFStatistics {
     ...
     */
    @BigDBProperty("transmit-packets")
     ...
     */
    @BigDBProperty("transmit-dropped")
     ...
     */
    @BigDBProperty("receive-frame-errors")
     ...
     */
    @BigDBProperty("receive-overrun-errors")
     ...
     */
    @BigDBProperty("receive-crc-errors")
