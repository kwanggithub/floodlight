...
public class OFDescriptionStatistics implements OFStatistics {
    public static final int DESCRIPTION_STRING_LENGTH = 256;
    public static final int SERIAL_NUMBER_LENGTH = 32;
    public static final int MESSAGE_LENGTH = 1056;
     ...
     */
    @BigDBProperty("manufacturer-description")
     ...
     */
    @BigDBProperty("hardware-description")
     ...
     */
    @BigDBProperty("software-description")
     ...
     */
    @BigDBProperty("datapath-description")
