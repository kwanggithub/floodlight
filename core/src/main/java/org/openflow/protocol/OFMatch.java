...
@BigDBSerialize(using = OFMatchSerializer.class)
...
public class OFMatch implements Cloneable, Serializable {
    ...
    final public static String STR_IN_PORT = "in-port";
    final public static String STR_DL_DST = "dl-dst";
    final public static String STR_DL_SRC = "dl-src";
    final public static String STR_DL_TYPE = "dl-type";
    final public static String STR_DL_VLAN = "dl-vlan";
    final public static String STR_DL_VLAN_PCP = "dl-vlan-pcp";
    final public static String STR_NW_DST = "nw-dst";
    final public static String STR_NW_SRC = "nw-src";
    final public static String STR_NW_PROTO = "nw-proto";
    final public static String STR_NW_TOS = "nw-tos";
    final public static String STR_TP_DST = "tp-dst";
    final public static String STR_TP_SRC = "tp-src";
     ...
     *         match)
     */
    public static int getNetworkDestinationMaskLen(int wildcards) {
        return Math.max(32 - ((wildcards & OFPFW_NW_DST_MASK) >> OFPFW_NW_DST_SHIFT),
                        0);
    }
    
    /**
     * @See getNetworkDestinationMaskLen(int wildcards)
     * @return
     */
    public int getNetworkDestinationMaskLen() {
        return getNetworkDestinationMaskLen(this.wildcards);
    }
     ...
     */
    public static int getNetworkSourceMaskLen(int wildcards) {
        return Math.max(32 - ((wildcards & OFPFW_NW_SRC_MASK) >> OFPFW_NW_SRC_SHIFT),
                        0);
    }
    
    /**
     * @See getNetworkSourceMaskLen(int wildcards).
     * @return
     */
    public int getNetworkSourceMaskLen() {
        return getNetworkSourceMaskLen(this.wildcards);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((wildcards & OFMatch.OFPFW_ALL) != (other.wildcards & OFPFW_ALL)) {
            // only consider allocated part of wildcards
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        ...
        if ((str.length() > 0) && (str.charAt(0) == ','))
                                                         str = str.substring(1); // trim
                                                                                 ...
                                                                                 // ","
        // done
        return "OFMatch[" + str + ", wildcards = [" + Wildcards.of(this.wildcards).toString() + "]]";
    }
    ...
    public static String cidrToString(int ip, int prefix) {
        String str;
        if (prefix >= 32) {
            str = IPv4.fromIPv4Address(ip);
        } else {
            // use the negation of mask to fake endian magic
            int mask = ~((1 << (32 - prefix)) - 1);
            str = IPv4.fromIPv4Address(ip & mask) + "/" + prefix;
        }
     ...
     * @throws IllegalArgumentException
     */
    public void setFromCIDR(String cidr, String which) throws IllegalArgumentException {
