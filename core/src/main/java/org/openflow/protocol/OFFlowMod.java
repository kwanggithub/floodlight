...
public class OFFlowMod extends OFMessage implements OFActionFactoryAware, Cloneable {
    public static final int MINIMUM_LENGTH = 72;
     ...
     * @return
     */
    @BigDBProperty(value="hard-timeout")
     ...
     * @return
     */
    @BigDBProperty(value="idle-timeout")
