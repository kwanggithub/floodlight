...
import org.projectfloodlight.db.data.serializers.ToStringDataNodeSerializer;
...
public class SwitchPort {
    ...
    @BigDBProperty(value = "port")
    public int getPort() {
        return port;
    }

    @BigDBProperty(value = "status")
    @BigDBSerialize(using=ToStringDataNodeSerializer.class)    
