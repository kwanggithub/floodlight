...
package org.projectfloodlight.device;
...
import org.projectfloodlight.core.FloodlightContextStore;
...
public interface IDeviceService extends IFloodlightService {
    ...
    /**
     * Find devices that match the provided query. It first checks
     * the keyFields match the device manager's keyFields, it searches
     * the primary index to find the device. This interface is used to
     * query a device with a given device ID.
     * 
     * @param keyFields  the key fields to be matched
     * @param macAddress The MAC address
     * @param vlan the VLAN
     * @param ipv4Address the ipv4 address
     * @param switchDPID the switch DPID
     ...
     */
    public Iterator<? extends IDevice> queryDevices(EnumSet<DeviceField> keyFields,
                                                    Long macAddress,
                                                    Short vlan,
                                                    Integer ipv4Address, 
                                                    Long switchDPID,
    ...
    /**
     * return the entity classifier for this device manager service
     * @return
     */
