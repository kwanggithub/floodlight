...
import org.projectfloodlight.routing.IRoutingDecision;
...
import org.projectfloodlight.util.OFMessageDamper;
...
public abstract class ForwardingBase
    ...
    // XXX this is horrifying
    public static short flowIdleTimeout = 5; // in seconds
    public static short flowHardTimeout = 0; // infinite
    ...
    public boolean pushRoute(Route route, OFMatch match,
        ...
        fm.setIdleTimeout(flowIdleTimeout)
