...
public class Versioned<T> implements Serializable {
    ...
    public Versioned<T> cloneVersioned() {
        return new Versioned<T>(this.getValue(), this.version.copy());
    }
    ...
    public static final class HappenedBeforeComparator<S> 
        implements Comparator<Versioned<S>>, Serializable {

        private static final long serialVersionUID = 4805493658353206073L;
