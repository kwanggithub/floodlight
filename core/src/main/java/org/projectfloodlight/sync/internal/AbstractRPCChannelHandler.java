...
import org.projectfloodlight.sync.error.HandshakeTimeoutException;
...
import org.projectfloodlight.sync.thrift.AuthChallengeResponse;
...
import org.projectfloodlight.sync.thrift.EchoReplyMessage;
import org.projectfloodlight.sync.thrift.EchoRequestMessage;
...
import org.projectfloodlight.sync.thrift.SyncError;
    ...
    public void channelConnected(ChannelHandlerContext ctx,
        ...
        switch (getAuthScheme()) {
            case NO_AUTH:
                ...
                m.setAuthScheme(org.projectfloodlight.sync.thrift.
                                AuthScheme.NO_AUTH);
                break;
    ...
    protected void handleSMAuthenticated(SyncMessage bsm, Channel channel) {
        switch (bsm.getType()) {
            ...
            case CLUSTER_JOIN_RESPONSE:
                ...
                break;
            case LEADER:
                handleLeader(bsm.getLeader(), channel);
                break;
            case LEADER_CAND:
                handleLeaderCand(bsm.getLeaderCand(), channel);
                break;
            case LEADER_ACK:
                handleLeaderAck(bsm.getLeaderAck(), channel);
                break;
            case ERROR:
                handleError(bsm.getError(), channel);
                break;
