...
import org.projectfloodlight.sync.internal.RPCService.NodeMessage;
...
import org.projectfloodlight.sync.thrift.CursorRequestMessage;
import org.projectfloodlight.sync.thrift.CursorResponseMessage;
import org.projectfloodlight.sync.thrift.DeleteRequestMessage;
import org.projectfloodlight.sync.thrift.DeleteResponseMessage;
import org.projectfloodlight.sync.thrift.ErrorMessage;
import org.projectfloodlight.sync.thrift.FullSyncRequestMessage;
import org.projectfloodlight.sync.thrift.GetRequestMessage;
import org.projectfloodlight.sync.thrift.GetResponseMessage;
...
import org.projectfloodlight.sync.thrift.LeaderAckMessage;
import org.projectfloodlight.sync.thrift.LeaderCandMessage;
import org.projectfloodlight.sync.thrift.LeaderMessage;
import org.projectfloodlight.sync.thrift.MessageType;
import org.projectfloodlight.sync.thrift.PutRequestMessage;
import org.projectfloodlight.sync.thrift.PutResponseMessage;
import org.projectfloodlight.sync.thrift.RegisterRequestMessage;
import org.projectfloodlight.sync.thrift.RegisterResponseMessage;
import org.projectfloodlight.sync.thrift.SyncMessage;
import org.projectfloodlight.sync.thrift.SyncOfferMessage;
import org.projectfloodlight.sync.thrift.SyncRequestMessage;
import org.projectfloodlight.sync.thrift.SyncValueMessage;
import org.projectfloodlight.sync.thrift.SyncValueResponseMessage;
...
public class RPCChannelHandler extends AbstractRPCChannelHandler {
    ...
    protected void handleSyncOffer(SyncOfferMessage request,
        ...
        try {
            ...
            for (KeyedVersions kv : request.getVersions()) {
                Iterable<org.projectfloodlight.sync.thrift.VectorClock> tvci =
                        kv.getVersions();
    ...
    protected void handleClusterJoinRequest(ClusterJoinRequestMessage request,
        ...
        try {
            ...
            org.projectfloodlight.sync.thrift.Node tnode = request.getNode();
            ...
            while (true) {
                try {
                    Versioned<ClusterNode> node =
                            nodeStoreClient.get(tnode.getNodeId());
                    node.setValue(new ClusterNode(tnode.getHostname(),
                                                  tnode.getPort(),
                                                  tnode.getNodeId(),
                                                  tnode.getDomainId()));
    ...
    @Override
    protected void handleLeader(LeaderMessage message,
                                Channel channel) {
        try {
            clusterManager.leader(message.getLeaderNodeId(),
                                  message.getLeaderWeight());
        } catch (Exception e) {
            channel.write(getError(message.getHeader().getTransactionId(), e,
                                   MessageType.LEADER));
        }
    }

    @Override
    protected void handleLeaderCand(LeaderCandMessage message,
                                    Channel channel) {
        try {
            clusterManager.leaderCand(message.getCandNodeId(),
                                      message.getCandWeight());
        } catch (Exception e) {
            channel.write(getError(message.getHeader().getTransactionId(), e,
                                   MessageType.LEADER));
        }
    ...
    @Override
    protected void handleLeaderAck(LeaderAckMessage message,
                                   Channel channel) {
        try {
            clusterManager.leaderAck(message.getLeaderNodeId());
        } catch (Exception e) {
            channel.write(getError(message.getHeader().getTransactionId(), e,
                                   MessageType.LEADER));
        }
    ...
    protected static class TVersionIterable
        ...
        final Iterable<org.projectfloodlight.sync.thrift.VectorClock> tcvi;

        public TVersionIterable(Iterable<org.projectfloodlight.sync.thrift.VectorClock> tcvi) {
            this.tcvi = tcvi;
        }

        @Override
        public Iterator<VectorClock> iterator() {
            final Iterator<org.projectfloodlight.sync.thrift.VectorClock> tcs =
                    tcvi.iterator();
