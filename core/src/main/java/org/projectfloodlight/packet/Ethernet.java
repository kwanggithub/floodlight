...
public class Ethernet extends BasePacket {
    ...
    public static final Map<Short, Class<? extends IPacket>> etherTypeClassMap;
    ...
    private void updateParsingErrorCounter()
    {
        // XXX - ugh.  A static instance of Controller with public members
        // being accessed statically?
        Controller.Counters counters =
                Controller.getInstance().getCounters();
        counters.packetParsingError.updateCounterNoFlush();
    }
