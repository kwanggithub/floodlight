...
import org.projectfloodlight.counter.ICounter;
import org.projectfloodlight.counter.ICounterStoreService;
import org.projectfloodlight.counter.SimpleCounter;
...
import org.projectfloodlight.flowcache.FlowReconcileQuery.FlowReconcileQueryDebugEvent;
        ...
        if (ofmRcList.size() > 0) {
            ...
            for (OFMatchReconcile ofmRc : ofmRcList) {
                if (ofmRc.origReconcileQueryEvent != null) {
                    ofmRc.origReconcileQueryEvent.getEvType().getDebugEvent()
