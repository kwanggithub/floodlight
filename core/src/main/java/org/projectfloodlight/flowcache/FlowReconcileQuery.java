...
public class FlowReconcileQuery {
    private ReconcileQueryEvType evType;
    private EventPriority evPriority;
    ...
    public static enum ReconcileQueryEvType {
        ...
        /* device had moved to a different port in the network,
         * remove the flow mods sourced from the moved device  */
        DEVICE_MOVED_REMOVE_SOURCE_FLOW(EventPriority.HIGH,
            "Flow Remove Events triggered by Host moves"),
    ...
    public ReconcileQueryEvType getEvType() {
        return evType;
    }

    public EventPriority getEvPriority() {
        return evPriority;
    }

    public void setEvType(ReconcileQueryEvType evType) {
        this.evType = evType;
    }

    public void setEvPriority(EventPriority evPriority) {
