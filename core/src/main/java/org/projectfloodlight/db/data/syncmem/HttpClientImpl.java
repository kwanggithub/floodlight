...
public class HttpClientImpl implements HttpClient, HttpClientImplMBean {
    ...
    HttpClientImpl(ClientBootstrap bootstrap, DefaultChannelGroup channelGroup, URI uri, HttpClientStats stats) {
        ...
        try {
            ObjectName objectName = new ObjectName("org.projectfloodlight.db:type=HttpClientImpl,name="+this.uri.getHost() + "/" + this.uri.getPath());
     ...
     * (non-Javadoc)
     * @see
     * org.projectfloodlight.db.data.persistmem.IHttpClient#request(org.jboss.netty.handler
    ...
    /* (non-Javadoc)
     * @see org.projectfloodlight.db.data.syncmem.HttpClientImplMBean#getState()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.projectfloodlight.db.data.syncmem.HttpClientImplMBean#getUri()
     */
    @Override
    public URI getUri() {
        return uri;
    ...
    /* (non-Javadoc)
     * @see org.projectfloodlight.db.data.syncmem.HttpClientImplMBean#getStats()
     */
    @Override
