...
import org.projectfloodlight.db.auth.password.MultiPasswordHasher;
import org.projectfloodlight.db.auth.password.PasswordHasher;
import org.projectfloodlight.db.auth.session.FileSessionManager;
 ...
 *           Param.booleanParam("enabled", "org.projectfloodlight.db.useAuth");
 *  </pre>
 *   defines a parameter with the logical name "enabled", who has a 
 *   corresponding system property "org.projectfloodlight.db.useAuth".
 *  <p>
...
public class AuthConfig {
    ...
    public static final String SYSPROP_USE_AUTH =
        "org.projectfloodlight.db.useAuth";
    ...
    */
    ...
    public static class Param<T> {
        ...
        Param(Class<T> clazz, String name) {
            this(clazz, name, "org.projectfloodlight.db.auth."+name);
        }
