...
struct LeaderMessage {
  1: required AsyncMessageHeader header,
  2: optional i16 domainId,
  3: optional i16 leaderNodeId,
  4: optional i32 leaderWeight
}

struct LeaderCandMessage {
  1: required AsyncMessageHeader header,
  2: optional i16 domainId,
  3: optional i16 candNodeId,
  4: optional i32 candWeight
}

struct LeaderAckMessage {
  1: required AsyncMessageHeader header,
  2: optional i16 domainId,
  3: optional i16 leaderNodeId
}
...
struct SyncMessage {
  ...
  23: optional LeaderMessage leader,
  24: optional LeaderCandMessage leaderCand,
  25: optional LeaderAckMessage leaderAck
}