...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class LeaderAckMessage implements org.apache.thrift.TBase<LeaderAckMessage, LeaderAckMessage._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("LeaderAckMessage");
  ...
  static {
    schemes.put(StandardScheme.class, new LeaderAckMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LeaderAckMessageTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.DOMAIN_ID,_Fields.LEADER_NODE_ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(LeaderAckMessage.class, metaDataMap);
  }

  public LeaderAckMessage() {
  }
   ...
   */
  public LeaderAckMessage(LeaderAckMessage other) {
  ...
  public LeaderAckMessage deepCopy() {
    return new LeaderAckMessage(this);
  }
  ...
  public LeaderAckMessage setHeader(AsyncMessageHeader header) {
    this.header = header;
    return this;
  }
  ...
  public LeaderAckMessage setDomainId(short domainId) {
  ...
  public LeaderAckMessage setLeaderNodeId(short leaderNodeId) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof LeaderAckMessage)
      return this.equals((LeaderAckMessage)that);
    return false;
  }

  public boolean equals(LeaderAckMessage that) {
    if (that == null)
      return false;
  ...
  public int compareTo(LeaderAckMessage other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    LeaderAckMessage typedOther = (LeaderAckMessage)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LeaderAckMessage(");
    boolean first = true;
  ...
  private static class LeaderAckMessageStandardSchemeFactory implements SchemeFactory {
    public LeaderAckMessageStandardScheme getScheme() {
      return new LeaderAckMessageStandardScheme();
    }
  }

  private static class LeaderAckMessageStandardScheme extends StandardScheme<LeaderAckMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, LeaderAckMessage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LeaderAckMessage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class LeaderAckMessageTupleSchemeFactory implements SchemeFactory {
    public LeaderAckMessageTupleScheme getScheme() {
      return new LeaderAckMessageTupleScheme();
    }
  }

  private static class LeaderAckMessageTupleScheme extends TupleScheme<LeaderAckMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, LeaderAckMessage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, LeaderAckMessage struct) throws org.apache.thrift.TException {
