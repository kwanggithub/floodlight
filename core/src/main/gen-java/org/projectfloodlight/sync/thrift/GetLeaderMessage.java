...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class GetLeaderMessage implements org.apache.thrift.TBase<GetLeaderMessage, GetLeaderMessage._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetLeaderMessage");
  ...
  static {
    schemes.put(StandardScheme.class, new GetLeaderMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetLeaderMessageTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.DOMAIN_ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetLeaderMessage.class, metaDataMap);
  }

  public GetLeaderMessage() {
  }
   ...
   */
  public GetLeaderMessage(GetLeaderMessage other) {
  ...
  public GetLeaderMessage deepCopy() {
    return new GetLeaderMessage(this);
  }
  ...
  public GetLeaderMessage setHeader(AsyncMessageHeader header) {
    this.header = header;
    return this;
  }
  ...
  public GetLeaderMessage setDomainId(short domainId) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetLeaderMessage)
      return this.equals((GetLeaderMessage)that);
    return false;
  }

  public boolean equals(GetLeaderMessage that) {
    if (that == null)
      return false;
  ...
  public int compareTo(GetLeaderMessage other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    GetLeaderMessage typedOther = (GetLeaderMessage)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetLeaderMessage(");
    boolean first = true;
  ...
  private static class GetLeaderMessageStandardSchemeFactory implements SchemeFactory {
    public GetLeaderMessageStandardScheme getScheme() {
      return new GetLeaderMessageStandardScheme();
    }
  }

  private static class GetLeaderMessageStandardScheme extends StandardScheme<GetLeaderMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetLeaderMessage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetLeaderMessage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetLeaderMessageTupleSchemeFactory implements SchemeFactory {
    public GetLeaderMessageTupleScheme getScheme() {
      return new GetLeaderMessageTupleScheme();
    }
  }

  private static class GetLeaderMessageTupleScheme extends TupleScheme<GetLeaderMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetLeaderMessage struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetLeaderMessage struct) throws org.apache.thrift.TException {
