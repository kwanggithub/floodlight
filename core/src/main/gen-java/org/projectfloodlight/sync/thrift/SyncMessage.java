...
@SuppressWarnings({"all", "unchecked", "rawtypes"}) public class SyncMessage implements org.apache.thrift.TBase<SyncMessage, SyncMessage._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField LEADER_FIELD_DESC = new org.apache.thrift.protocol.TField("leader", org.apache.thrift.protocol.TType.STRUCT, (short)23);
  private static final org.apache.thrift.protocol.TField LEADER_CAND_FIELD_DESC = new org.apache.thrift.protocol.TField("leaderCand", org.apache.thrift.protocol.TType.STRUCT, (short)24);
  private static final org.apache.thrift.protocol.TField LEADER_ACK_FIELD_DESC = new org.apache.thrift.protocol.TField("leaderAck", org.apache.thrift.protocol.TType.STRUCT, (short)25);
  ...
  public LeaderMessage leader; // optional
  public LeaderCandMessage leaderCand; // optional
  public LeaderAckMessage leaderAck; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    LEADER((short)23, "leader"),
    LEADER_CAND((short)24, "leaderCand"),
    LEADER_ACK((short)25, "leaderAck");
  ...
  static {
    ...
    tmpMap.put(_Fields.LEADER, new org.apache.thrift.meta_data.FieldMetaData("leader", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, LeaderMessage.class)));
    tmpMap.put(_Fields.LEADER_CAND, new org.apache.thrift.meta_data.FieldMetaData("leaderCand", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, LeaderCandMessage.class)));
    tmpMap.put(_Fields.LEADER_ACK, new org.apache.thrift.meta_data.FieldMetaData("leaderAck", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, LeaderAckMessage.class)));
  ...
  public SyncMessage(SyncMessage other) {
    ...
    if (other.isSetLeader()) {
      this.leader = new LeaderMessage(other.leader);
    }
    if (other.isSetLeaderCand()) {
      this.leaderCand = new LeaderCandMessage(other.leaderCand);
    }
    if (other.isSetLeaderAck()) {
      this.leaderAck = new LeaderAckMessage(other.leaderAck);
    }
  }
  ...
  public LeaderMessage getLeader() {
    return this.leader;
  }

  public SyncMessage setLeader(LeaderMessage leader) {
    this.leader = leader;
    return this;
  }
  ...
  public LeaderCandMessage getLeaderCand() {
    return this.leaderCand;
  }

  public SyncMessage setLeaderCand(LeaderCandMessage leaderCand) {
    this.leaderCand = leaderCand;
    return this;
  }

  public void unsetLeaderCand() {
    this.leaderCand = null;
  }

  /** Returns true if field leaderCand is set (has been assigned a value) and false otherwise */
  public boolean isSetLeaderCand() {
    return this.leaderCand != null;
  }

  public void setLeaderCandIsSet(boolean value) {
    if (!value) {
      this.leaderCand = null;
    }
  }

  public LeaderAckMessage getLeaderAck() {
    return this.leaderAck;
  }

  public SyncMessage setLeaderAck(LeaderAckMessage leaderAck) {
    this.leaderAck = leaderAck;
    return this;
  }

  public void unsetLeaderAck() {
    this.leaderAck = null;
  }

  /** Returns true if field leaderAck is set (has been assigned a value) and false otherwise */
  public boolean isSetLeaderAck() {
    return this.leaderAck != null;
  }

  public void setLeaderAckIsSet(boolean value) {
    if (!value) {
      this.leaderAck = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LEADER_CAND:
      if (value == null) {
        ...
        setLeaderCand((LeaderCandMessage)value);
      }
      break;
    ...
    case LEADER_ACK:
      if (value == null) {
        ...
        setLeaderAck((LeaderAckMessage)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case LEADER:
      return isSetLeader();
    case LEADER_CAND:
      return isSetLeaderCand();
    case LEADER_ACK:
      return isSetLeaderAck();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(SyncMessage that) {
    ...
    boolean this_present_leaderCand = true && this.isSetLeaderCand();
    boolean that_present_leaderCand = true && that.isSetLeaderCand();
    if (this_present_leaderCand || that_present_leaderCand) {
      if (!(this_present_leaderCand && that_present_leaderCand))
        return false;
      if (!this.leaderCand.equals(that.leaderCand))
        return false;
    }

    boolean this_present_leaderAck = true && this.isSetLeaderAck();
    boolean that_present_leaderAck = true && that.isSetLeaderAck();
    if (this_present_leaderAck || that_present_leaderAck) {
      if (!(this_present_leaderAck && that_present_leaderAck))
        return false;
      if (!this.leaderAck.equals(that.leaderAck))
        return false;
    }
  ...
  public int compareTo(SyncMessage other) {
    ...
    lastComparison = Boolean.valueOf(isSetLeaderCand()).compareTo(typedOther.isSetLeaderCand());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLeaderCand()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.leaderCand, typedOther.leaderCand);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLeaderAck()).compareTo(typedOther.isSetLeaderAck());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLeaderAck()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.leaderAck, typedOther.leaderAck);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetLeaderCand()) {
      if (!first) sb.append(", ");
      sb.append("leaderCand:");
      if (this.leaderCand == null) {
        sb.append("null");
      } else {
        sb.append(this.leaderCand);
      }
      first = false;
    }
    if (isSetLeaderAck()) {
      if (!first) sb.append(", ");
      sb.append("leaderAck:");
      if (this.leaderAck == null) {
        sb.append("null");
      } else {
        sb.append(this.leaderAck);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class SyncMessageStandardScheme extends StandardScheme<SyncMessage> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SyncMessage struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 23: // LEADER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.leader = new LeaderMessage();
          ...
          case 24: // LEADER_CAND
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.leaderCand = new LeaderCandMessage();
              struct.leaderCand.read(iprot);
              struct.setLeaderCandIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 25: // LEADER_ACK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.leaderAck = new LeaderAckMessage();
              struct.leaderAck.read(iprot);
              struct.setLeaderAckIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SyncMessage struct) throws org.apache.thrift.TException {
      ...
      if (struct.leaderCand != null) {
        if (struct.isSetLeaderCand()) {
          oprot.writeFieldBegin(LEADER_CAND_FIELD_DESC);
          struct.leaderCand.write(oprot);
          oprot.writeFieldEnd();
        }
      }
      if (struct.leaderAck != null) {
        if (struct.isSetLeaderAck()) {
          oprot.writeFieldBegin(LEADER_ACK_FIELD_DESC);
          struct.leaderAck.write(oprot);
          oprot.writeFieldEnd();
        }
      }
